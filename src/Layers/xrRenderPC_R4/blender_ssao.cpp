...
void	CBlender_SSAO::Compile			(CBlender_Compile& C)
{
	...
	switch(C.iElement) {
		...
		case 2:
		{
			C.r_Pass("stub_fullscreen_triangle", "hiz_depth_render", FALSE, FALSE, FALSE);
			C.r_dx10Texture("s_position", r2_RT_P);
		...
		case 3:
		{
			C.r_Pass("stub_fullscreen_triangle", "hiz_depth_filter", FALSE, FALSE, FALSE);
			C.r_dx10Texture("s_position", r2_RT_half_depth);
